...
struct AcDimmerDataStore {
  ...
  /// Dimmer method
  DimMethod method;
  /// Gate enable pulse time in microseconds
  uint32_t gate_enable_time;
...
class AcDimmer : public output::FloatOutput, public Component {
 public:
  ...
  void set_gate_enable_time(uint32_t gate_enable_time) { gate_enable_time_ = gate_enable_time; }
