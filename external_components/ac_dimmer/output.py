...
CONF_GATE_ENABLE_TIME = "gate_enable_time"
    ...
    output.FLOAT_OUTPUT_SCHEMA.extend(
        {
            ...
            cv.Optional(CONF_GATE_ENABLE_TIME, default=50): cv.positive_int,
        }
...
async def to_code(config):
    ...
    cg.add(var.set_gate_enable_time(config[CONF_GATE_ENABLE_TIME]))
